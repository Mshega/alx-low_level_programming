...
/**
 * print_class - Printing a class of an ELF header.
...
/**
 * print_data - Prints a data of an ELF header.
 * @e_ident: Pointer to an array containing the ELF class.
 */
void print_data(unsigned char *e_ident)
{
...
/**
 * main - Display an information contained in the
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	z = read(x, header, sizeof(Elf64_Ehdr));
	if (z == -1)
	{
		free(header);
		close_elf(x);
